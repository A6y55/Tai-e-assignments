...
public class ConstantPropagation extends
    ...
    public static Value evaluate(Exp exp, CPFact in) {
        ...
        if(exp instanceof IntLiteral){
            ...
            if ((op==ArithmeticExp.Op.DIV||op==ArithmeticExp.Op.REM)&& v2.isConstant()&&v2.getConstant()==0){
            ...
            if (op==ArithmeticExp.Op.MUL
                    &&(v1.isConstant()&&v1.getConstant()==0&&v2.isNAC()||
                    v2.isConstant()&&v2.getConstant()==0&& v1.isNAC())){
